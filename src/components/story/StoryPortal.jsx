                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center z-10">
                    ...
                    >
                        ...
                        <p className="text-aevon-cream/90 text-lg mb-8 max-w-md mx-auto leading-relaxed shadow-black drop-shadow-md">
                            Not just vocabulary, learn lifestyle and history in a 3D world
                        </p>
            ...
            {isJourneyActive && (
                ...
                >
                    ...
                    <button
                        ...
                        className="absolute top-6 right-6 z-[110] text-aevon-cream hover:text-aevon-coral transition-colors duration-300 text-2xl font-bold leading-none"
                    >
                        ✕
                    </button>
                    ...
                    {/* The Game Iframe */}
                    <iframe
                        src={import.meta.env.VITE_GAME_URL || "https://culture-canvas-puce.vercel.app"}
